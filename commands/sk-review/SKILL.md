...
When this skill is activated (via `/sk-review`), execute the Code Review Workflow:
...
3. Automatically generate or update the `review.md` file under `sk-specs/active/<work-item-name>/` using the structure in `sk-specs/templates/sk-review.md`.
