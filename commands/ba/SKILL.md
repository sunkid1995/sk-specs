...
When this skill is activated (via `/ba`), execute the Business Analysis Workflow:
...
3. Automatically generate or update the `ba.md` file using the format specified in `.agents/sk-specs/templates/ba.md`.
