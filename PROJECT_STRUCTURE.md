...
- [slash-commands.md](rules/slash-commands.md)
  ...
  - **Tính năng:** Hỗ trợ kích hoạt trực tiếp các workflow và checkpoint (như `/sk-ba`, `/sk-feature`, `/sk-bugfix`, `/sk-refactor`, `/sk-review`, `/sk-continue`, `/sync`), tối giản hóa quá trình tương tác.
- [spec-loading.md](rules/spec-loading.md)
  - **Nhiệm vụ:** Điều phối hành vi tải (load) ngữ cảnh đặc tả kỹ thuật hiện tại.
  - **Tính năng:** Bắt buộc Agent tìm kiếm và tái sử dụng các quyết định, cấu trúc spec có sẵn trong `sk-specs/` để duy trì tính liên tục (Context Continuity) và tránh xung đột.
- [spec-persistence.md](rules/spec-persistence.md)
  - **Nhiệm vụ:** Điều phối hành vi ghi (lưu trữ) các đặc tả kỹ thuật.
  - **Tính năng:** Tự động lưu trữ đầu ra của Feature/Bug/Refactor vào thư mục `sk-specs/<work-item-name>/`; quy định cấu trúc file spec chuẩn và yêu cầu tối thiểu số lượng test cases.
...
- [feature-analysis/SKILL.md](skills/sk-feature-analysis/SKILL.md)
...
- [refactor-principles/SKILL.md](skills/sk-refactor-principles/SKILL.md)
...
- [feature-analysis.md](workflows/sk-feature-analysis.md)
...
- [feature-architecture.md](workflows/sk-feature-architecture.md)
...
- [feature-task-breakdown.md](workflows/sk-feature-task-breakdown.md)
...
- [ba/SKILL.md](commands/sk-ba/SKILL.md)
  - **Nhiệm vụ:** Custom Slash Command `/sk-ba`. Kích hoạt Business Analysis workflow và sinh `ba.md`.
- [feature/SKILL.md](commands/sk-feature/SKILL.md)
  - **Nhiệm vụ:** Custom Slash Command `/sk-feature`. Kích hoạt Feature workflow và sinh `feature.md`.
- [bugfix/SKILL.md](commands/sk-bugfix/SKILL.md)
  - **Nhiệm vụ:** Custom Slash Command `/sk-bugfix`. Kích hoạt Bugfix workflow và sinh `fix-bug.md`.
- [refactor/SKILL.md](commands/sk-refactor/SKILL.md)
  - **Nhiệm vụ:** Custom Slash Command `/sk-refactor`. Kích hoạt Safe Refactor workflow và sinh `refactor.md`.
- [review/SKILL.md](commands/sk-review/SKILL.md)
...
- [status/SKILL.md](commands/sk-status/SKILL.md)
  - **Nhiệm vụ:** Custom Slash Command `/sk-status`. Kiểm tra trạng thái hiện tại của dự án, các file spec và tóm tắt tiến trình.
...
- [pre-review.js](hooks/pre-review.js)
  - **Nhiệm vụ:** Kiểm tra trước khi tạo review. Đảm bảo checklist tiến độ trong `progress.md` hoàn thành và có thay đổi mã nguồn thực tế trong Git trước khi tạo review.
- [post-review.js](hooks/post-review.js)
  - **Nhiệm vụ:** Kiểm tra sau khi hoàn thành review. Tự động kiểm tra nếu `review.md` tồn tại và `progress.md` ghi nhận trạng thái Completed cùng toàn bộ đầu việc đã xong để di chuyển thư mục tiến trình từ `active/` sang `completed/`.
